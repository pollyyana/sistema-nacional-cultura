...
urlpatterns = [
    ...
    url(
        r"^sistema/$", login_required(views.CadastrarSistema.as_view()),
    ...
    url(r"^plano/$", login_required(views.CadastrarPlano.as_view()), name="plano"),
    url(
        r"^plano/(?P<pk>[0-9]+)/$",
