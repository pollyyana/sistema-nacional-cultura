...
def preenche_planilha(planilha):
    ...
    planilha.write(0, 9, "Endereço")
    planilha.write(0, 10, "Bairro")
    planilha.write(0, 11, "CEP")
    planilha.write(0, 12, "Telefone")
    planilha.write(0, 13, "Email Prefeito")
    planilha.write(0, 14, "Email do Cadastrador")
    planilha.write(0, 15, "Email do Responsável")
    planilha.write(0, 16, "Localização do processo")
    ultima_linha = 0
    ...
    for i, sistema in enumerate(SistemaCultura.sistema.all(), start=1):
        ...
        planilha.write(i, 9, endereco)
        planilha.write(i, 10, bairro)
        planilha.write(i, 11, cep)
        planilha.write(i, 12, telefone)
        planilha.write(i, 13, email_gestor)
        planilha.write(i, 14, email_cadastrador)
        planilha.write(i, 15, email_responsavel)
        planilha.write(i, 16, local)
